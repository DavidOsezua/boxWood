      ...
      <div className={`${styles.overviewContainer} sectionContainer`}>
        ...
        >
          ...
          <p className={`${styles.text}`}>
            ...
            Established in 2019, we have built a solid reputation for delivering
            expert legal and financial recovery services across various sectors.
          </p>
          <p className={`${styles.text}`}>
            {" "}
            Our team is led by Director (Chief executive) Henry William Foster,
            with the support of Secretary Miss Inca Lockhart-Ross. Together,
